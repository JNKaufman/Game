...
while quit != "no":
    ...
    print("----------------------")
    print("\n")
    print("You find yourself in an open field. In front of you is a forest. To your left is a cave, and to the right is more of the field.") # Opening prompt
    print("Go left")
    print("Go right")
    print("Go forward")
    print("Go backwards")
    ...
    elif ans == "go forward": #Go forward
    ...
    elif ans == "go backwards":#Go backwards
